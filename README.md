...
<details open>
   <summary><h2><b> Лабораторная 1. Вариант 1307. </b></h2></summary>
  
  - [Требования для выполнения лабораторной работы №1 варианта `1307`](#требования-для-выполнения-лабораторной-работы-1-варианта-1307)
...
<a id="требования-для-выполнения-лабораторной-работы-1-варианта-1307"></a>
<details open>  
   <summary><h2><b> Требования для выполнения лабораторной работы №1 варианта `1307` </b></h2></summary>
...
5. [ ] 5. Страница должна содержать сценарий на языке JavaScript, осуществляющий валидацию значений, вводимых пользователем в поля формы. Любые некорректные значения (например, буквы в координатах точки или отрицательный радиус) должны блокироваться.
...
<a id="темы-для-подготовки-к-защите-лабораторной-работы"></a>
<details>  
   <summary><h2><b> Темы для подготовки к защите лабораторной работы </b></h2></summary>
...
<a id="как-запустить-чтобы-всё-работало"></a>
<details>  
   <summary><h2><b>  Как запустить чтобы всё работало? </b></h2></summary>
...
<a id="руководство-по-эксплуатации"></a>
<details>  
   <summary><h2><b>  Руководство по эксплуатации </b></h2></summary>
...
<a id="теоретические-материалы"></a>
<details>  
